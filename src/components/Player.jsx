...
<footer id="footer-artist" >
<div className="row player d-flex">
  <div
    className={"col-lg-2 d-md-none d-sm-none d-lg-block d-flex ml-4 mb-4"}
    id="nowPlaying">
    <div className={"row d-flex align-items-center"}>
      ...
      <div className="mx-3">
        <p
          className="creep"
          style={{fontsize:' 14px', color: '#ffff', marginbottom: '5px'}}
        >
          Creep
        </p>
        <p
          className="radiohead"
          style={{fontsize: '10px', color: '#ffff;', marginbottom: '0'}}
        >
          Radiohead
        </p>
      </div>
  ...
  <div className="col-lg-8 process d-flex justify-items-center mt-1">
    ...
    <div className="row songDur align-items-center my-1">
      ...
      <div className={"col"}>
        <p className="mb-0" style={ {color: '#ffff', fontSize: '10px'}} >5:07</p>
      </div>
    </div>
  </div>
